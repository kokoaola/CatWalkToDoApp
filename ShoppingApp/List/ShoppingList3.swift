...
//            //ラベルが2、未完了のものだけ抽出
//            predicate: NSPredicate(format: "label == %d And finished == %@", 2, NSNumber(value: false)), animation: .default
...
struct ShoppingList3_Previews: PreviewProvider {
